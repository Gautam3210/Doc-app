    ...
    <div>
     ...
     <div className='my-10 flex flex-col md:flex-row gap-12'>
      ...
      <strong>Prescripto</strong> is a modern digital healthcare platform designed to simplify the process of finding trusted doctors, booking appointments, and managing your health. Our goal is to bridge the gap between patients and healthcare providers using smart, user-friendly technology.
        ...
        <p>
          We work with a wide network of certified doctors across various specialties to ensure quality care. All our listed doctors go through a strict verification process to maintain trust and transparency.
        </p>

        <p>
  <strong className='text-gray-800'>Our Vision:</strong> At Prescripto, we envision a world where healthcare is not a privilege, but a seamless part of everyday life. We are committed to building a future where every individual has instant access to quality medical care — regardless of time, place, or circumstance. Through innovation, empathy, and technology, we aim to create a healthier, more connected world — one appointment at a time.
</p>
        
        <p>
          Your health is personal — and so is our approach. With Prescripto, you can:
        </p>
            </div>
     </div>
     ...
     <div className='flex flex-col md:flex-row mb-20'>
      ...
      <div className='border px-10 md:px-16 py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer'>
        <b>Personalization:</b>
        <p>Get health tips, reminders, and doctor suggestions made just for you.</p>
