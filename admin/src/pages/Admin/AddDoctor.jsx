...
const onSubmitHandler = async (event) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className="m-5 w-full">
      ...
      <div className="bg-white px-8 py-6 border rounded w-full max-w-4xl max-h-[80vh] overflow-auto">
        {/* Upload area */}
        ...
        <button
          type="submit"
          className="bg-primary hover:bg-blue-700 px-10 py-3 mt-4 text-white rounded-full transition-all"
        >
          Add Doctor
        </button>
      </div>
